    ...
    <v-container class="mt-5">
                ...
                <v-col cols="12" sm="8">
                  <v-list-item three-line>
                    <v-list-item-content>
                      ...
                      <v-list-item-subtitle class="white--text">Market Cap $151.34</v-list-item-subtitle>
                    </v-list-item-content>
                  </v-list-item>
                </v-col>
                <v-col cols="12" sm="4">
                  <v-avatar size="100" class="ml-n10" tile>
                    <v-img src="wallet.png"></v-img>
                  </v-avatar>
                </v-col>
              </v-row>
      ...
      <v-row>
          ...
          <v-card>
            ...
            <v-app-bar flat color="rgba(0,0,0,0)">
              ...
              <v-toolbar-title class="title black--text ml-2">
                Sent Bitcoin <span class="caption"><b>To Bitcoin Address</b></span>
              </v-toolbar-title>
              <v-spacer></v-spacer>
              <v-toolbar-title class="subtitle black--text ml-2">
                -0.00257 BTC
              </v-toolbar-title>
            ...
            <v-app-bar flat color="rgba(0,0,0,0)">
              ...
              <v-toolbar-title class="title black--text ml-2">
                Recieved Litecoin <span class="caption"><b>Pending</b></span>
              </v-toolbar-title>
              <v-spacer></v-spacer>
              <v-toolbar-title class="subtitle black--text ml-2">
                -0.0133634 LTC
            ...
            <v-col cols="12" sm="8">
              ...
              <v-card-action class="justify-end">
                <v-btn text color="green">
                  <v-icon class="mt-n2 pr-2">fas fa-sort-down</v-icon>8.2
                </v-btn>
              </v-card-action>
            </v-col>
          </v-row>
        ...
        <v-col cols="12" sm="6">
          ...
          <v-list-item three-line>
            <v-list-item-content>
              <div class="mb-4">Your Portifolio</div>
              <v-row>
                <v-col cols="12" sm="6">
                  <v-progress-circular
                  rotate="360"
                ...
                <v-col cols="12" sm="6">
                  <v-list-item-subtitle class="grey--text mt-8">2.566 BTC</v-list-item-subtitle>
                  <v-list-item-subtitle class="grey--text mt-8">$2.5M USD</v-list-item-subtitle>
                </v-col>
